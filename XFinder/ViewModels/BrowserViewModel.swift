...
final class BrowserViewModel: ObservableObject {
    ...
    private static let germanTranslations: [String: String] = [
        ...
        "Files": "Dateien",
        "Network": "Netzwerk",
        "Discovered file servers and mounted network shares": "Erkannte Dateiserver und gemountete Netzwerkfreigaben",
        "Connect to Server…": "Mit Server verbinden …",
        "Connect to Server": "Mit Server verbinden",
        "Server discovered; address is still being resolved": "Server erkannt; die Adresse wird noch aufgelöst",
